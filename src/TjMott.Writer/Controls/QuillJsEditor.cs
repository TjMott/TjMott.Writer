...
namespace TjMott.Writer.Controls
{
    ...
    public class QuillJsEditor : AvaloniaCefBrowser
    {
        ...
        public static async Task<bool> VerifyHashes()
        {
            ...
            AssetHashes.Add(new AssetHash(Path.Join("Assets", "quilljs", "quill.bubble.css.map"), "E8E966FBBE4848DABF3C2B7E2C899A78659FEF4FF742420DA8FE38CD5C219238"));
            ...
            AssetHashes.Add(new AssetHash(Path.Join("Assets", "quilljs", "quill.core.css.map"), "EDDF53780BF28A315F65A6846FEEB4CA82E62E06A74B9462152F4D87AD8D3BC4"));
            ...
            AssetHashes.Add(new AssetHash(Path.Join("Assets", "quilljs", "quill.core.js.map"), "6D4B501DF20B89117FB88294E8BD85813B254FF6A10184949A28DEF97F294C0B"));
            ...
            AssetHashes.Add(new AssetHash(Path.Join("Assets", "quilljs", "quill.js.map"), "F11DE2930B4C68D015625D63EBDCC25CDB7B3B75A2BB2364DBC10597404BCC03"));
            ...
            AssetHashes.Add(new AssetHash(Path.Join("Assets", "quilljs", "quill.snow.css.map"), "137D947401EA1CA7F1954F4F6633F25EB7B0501E3E2AB3570921FAFDDADBC3DD"));
